            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        <input type="text" name="dari" class="form-control" placeholder="Dari" value="{{ $dari }}"
                            onfocus="(this.type='date')" onblur="(this.type='text')" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <input type="text" name="sampai" class="form-control" placeholder="Sampai" value="{{ $sampai }}"
                            onfocus="(this.type='date')" onblur="(this.type='text')" required>
                    </div>
                </div>
            </div>
