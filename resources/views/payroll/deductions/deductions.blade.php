        ...
        <div class="container-xl">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <div class="form-group mb-3">
                            <select id="deduction-type" class="form-control" data-table-target=".table-deductions-type">
                                <option value="">-- Pilih Tipe --</option>
                                <option value="1">Tetap</option>
                                <option value="2">Lain-Lain</option>
                            </select>
                        </div>
                        <table class="table table-bordered table-striped table-hover table-deductions-type mx-0 w-100">
                            <thead>
                                <tr align="middle">
                                    <th>NO</th>
                                    <th>NAMA POTONGAN</th>
            ...
            <div class="row mt-5">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-striped table-hover table-deductions mx-0 w-100">
                            <thead>
                                <tr align="middle">
                                    <th>NO</th>
                                    <th>NAMA KARYAWAN</th>
...
@push('myscript')
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            //     processing: true,
            //     serverSide: true,
            //     ajax: "{{ route('payroll.deductions.datatables') }}",
            //     columns: [
            //         {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
            //         {data: 'karyawan.nama_lengkap', name: ''},
            //         {data: 'jenis_potongan.nama_potongan', name: 'jenis_potongan.nama_potongan'},
            //         {data: 'jml_potongan', name: 'jml_potongan'},
            //         {data: 'jenis_potongan.tipe', name: 'jenis_potongan.tipe'},
            //         {data: 'action', name: 'action', orderable: false, searchable: false},
            //     ],
            // });
        ...
        // JENIS POTONGAN
        $(document).on('click', '[data-action-jenis]' ,function(e) {
            const $this = $(this);
