                    ...
                    <div class="ml">
                        ...
                        <div class="f1">
                            <table>
                                ...
                                <tr>
                                    <td>Jenis Kontrak</td>
                                    <td>: Karyawan Tetap/PKWT/Percobaan</td>
                                </tr>
                            </table>
                                ...
                                <div class="row">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>UMLK</td>
                                                <td>: {{ 'Rp ' . number_format($result['totalumlk'], 0, ',', '.') }}
                                                </td>
                                                <td>Mangkir</td>
                                                <td>:
                                            ...
                                            <tr>
                                                ...
                                                <td> 0
                                                    {{-- @if ($result['tahunan'])
                                                        :
                                                        {{ 'Rp ' . number_format($result['tahunan']->jumlah, 0, ',', '.') }}
                                                    @else
                                                        : 0
                                                    @endif --}}
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td> 0
                                                    {{-- @if ($result['thr'])
                                                        :
                                                        {{ 'Rp ' . number_format($result['thr']->jumlah, 0, ',', '.') }}
                                                    @else
                                                        : 0
                                                    @endif --}}
                                                </td>
                                                <td>
                                                    {{ $result['karyawanGaji']->contract_status != 'percobaan' ? 'BPJS Kesehatan' : '' }}
                                                </td>
                                                <td>
                                                    {{ $result['karyawanGaji']->contract_status != 'percobaan' ? ': 0' : '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>BPJS</td>
                                                <td>: 0</td>
                                                <td> {{ $result['karyawanGaji']->contract_status != 'percobaan' ? 'BPJS Tenaga Kerja' : '' }}
                                                </td>
                                                <td>{{ $result['karyawanGaji']->contract_status != 'percobaan' ? ': 0' : '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>Lembur</td>
                                                <td>:
                                                    {{ 'Rp ' . number_format($result['totalgajilembur'], 0, ',', '.') }}
                                                </td>
                                                <td> Total Potongan</td>
                                                <td>:
                                                    {{ 'Rp ' . number_format($result['totalpotongan'], 0, ',', '.') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td colspan="6"></td>
                                                <td style="text-align: right"><strong>Sisa Cashbon</strong></td>
                                                <td><strong>: Rp 0</strong></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td style="text-align: right"><strong>Total Gaji</strong></td>
                                                <td><strong>: {{ 'Rp ' . number_format($result['totalseluruhgaji'] - $result['totalpotongan'], 0, ',', '.') }}</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    {{-- <div class="col-12">
                                    ...
                                    <div class="col-12 mb-5">
                                        <h3 class="text-center">Total Gaji
                                            :{{ 'Rp ' . number_format($result['totalseluruhgaji'] - $result['totalpotongan'], 0, ',', '.') }}
                                        </h3>
                                    </div> --}}
                                </div>
                            </div>
