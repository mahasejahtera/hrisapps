            ...
            <tr>
                ...
                <td>:<a href="{{ route('karyawan-track', ['id' => $data->id]) }}" class="text-danger">
                        ...
                        @elseif($data->manajer_approval == 1 && $data->pm_approval == 0)
                            Diperiksa oleh PM
                        @elseif($data->manajer_approval == 1 && $data->pm_approval == 1 && $data->hrd_approval == 0)
                            Diperiksa oleh HRD
                        @elseif(
        ...
        <div class="card m-2">
            <div class="card-body">
                ...
                <table>
                    <tr>
                        <td>Lampiran</td>
                        <td>: <a href="{{ asset('images/rencanakerja/revisi/' . $data->lampiran_revisi) }}"
                                target="_blank" class="text-danger">Klik disini</a></td>
                    </tr>
                    <tr>
                        <td>Keterangan</td>
                ...
                <div class="text-right"><a href="{{ route('karyawan-revisi', ['id' => $data->id]) }}"
