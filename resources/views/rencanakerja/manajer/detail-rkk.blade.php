    ...
    <div class="container-detail-task ml-2 mb-2 mr-2">
        <table>
            ...
            <tr>
                ...
                <td>:<a href="{{ route('manajer-track', ['id' => $data->id]) }}" class="text-danger">
                        @if ($data->manajer_approval == 1 && $data->pm_approval == 0)
                            Diperiksa oleh PM
    ...
    @if ($data->status == 3)
        <div class="card m-2">
            <div class="card-body">
                ...
                <div class="text-right"><a href="{{ route('manajer-revisi', ['id' => $data->id]) }}"
