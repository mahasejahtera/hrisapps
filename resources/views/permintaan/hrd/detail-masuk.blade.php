            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/manajer/hrd/permintaan/tolak" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="modal fade" id="exampleModalTerima" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/manajer/hrd/permintaan/terima" enctype="multipart/form-data">
                            @csrf
                            <div class="input-group">
                                div class="custom-file form-control">
                                <input type="file" class="custom-file-input" id="inputGroupFile04"
                                    aria-describedby="inputGroupFileAddon04" name="lampiran_penerima">
                                <label class="custom-file-label" for="inputGroupFile04">Lampiran</label>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" id="message-text" name="keterangan_penerima" placeholder="Keterangan" rows="5"></textarea>
                            </div>
                            <input type="hidden" name="id" value="{{ $data->id }}">
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
