...
@section('content')
    ...
    <div class="mt-3">
        <a href="/manajer/hrd/permintaan/masuk" class="text-dark">
    ...
    <div class="mt-3">
        <a href="/manajer/hrd/permintaan/keluar" class="text-dark">
            <div class="container-option">
    ...
    <div class="mt-3">
        <a href="/manajer/hrd/permintaan/persetujuan" class="text-dark">
            <div class="container-option">
