            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/karyawan/permintaan/tolak" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="modal fade" id="exampleModalTerima" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/karyawan/permintaan/terima" enctype="multipart/form-data">
                            @csrf
