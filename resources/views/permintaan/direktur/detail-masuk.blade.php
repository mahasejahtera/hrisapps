            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/direktur/permintaan/tolak" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="modal fade" id="exampleModalTerima" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/direktur/permintaan/terima" enctype="multipart/form-data">
                            @csrf
