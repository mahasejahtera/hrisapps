...
@section('content')
    ...
    <div class="mt-3">
        <a href="/direktur/permintaan/masuk" class="text-dark">
    ...
    <div class="mt-3">
        <a href="/direktur/permintaan/keluar" class="text-dark">
            <div class="container-option">
    ...
    <div class="mt-3">
        <a href="/direktur/permintaan/persetujuan" class="text-dark">
            <div class="container-option">
