...
@section('header')
    ...
    <div class="appHeader bg-danger text-light">
        ...
        <div class="pageTitle">Menu Lembur</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
@endsection
...
@section('content')
    <div class="menu-list-wrapper">
        <a href="{{ route('presensi.lembur.karyawan') }}" class="menu-list-item">
            <p>Lembur Karyawan</p>
        ...
        {{-- <a href="{{ route('presensi.lembur.pribadi') }}" class="menu-list-item">
            <p>Lembur Pribadi</p>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path d="M181.66,133.66l-80,80a8,8,0,0,1-11.32-11.32L164.69,128,90.34,53.66a8,8,0,0,1,11.32-11.32l80,80A8,8,0,0,1,181.66,133.66Z"></path></svg>
        </a> --}}
    </div>
