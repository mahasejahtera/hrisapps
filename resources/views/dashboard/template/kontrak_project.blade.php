        ...
        <div class="letter-body">
            <div class="letter-content">
                <div class="pasal-wrapper">
                    ...
                    <div class="pasal-body mt-2">
                        <P><strong>PIHAK PERTAMA</strong> dan <strong>PIHAK KEDUA</strong> sepakat bahwa perjanjian kerja ini dilaksanakan dengan waktu tertentu (PKWT) yaitu dimulai pada tanggal {{ tanggalIndo($karyawanBiodata[0]->karyawan->contract->mulai_kontrak) }} ({{ tanggalIndoText(tanggalIndo($karyawanBiodata[0]->karyawan->contract->mulai_kontrak)) }}) sampai dengan Proyek {{ $karyawanBiodata[0]->karyawan->contract->project }} selesai dilaksanakan.</P>
                    </div>
                </div>
            ...
            <div class="letter-content">
                <div class="pasal-wrapper">
                    ...
                    <div class="pasal-body mt-2">
                        <ol class="p-0">
                            <li>
                                <strong>PIHAK KEDUA</strong> akan bekerja sebagai {{ $karyawanBiodata[0]->karyawan->contract->jabatan->nama_jabatan }} Pada Proyek {{ $karyawanBiodata[0]->karyawan->contract->project }}.
                            </li>
                            <li>
                ...
                <div class="pasal-wrapper">
                    ...
                    <div class="pasal-body mt-2">
                        <ol class="p-0">
                            ...
                            <li>
                                Upah sebagaimana Ayat 1 Pasal ini sudah termasuk biaya makan <strong>PIHAK KEDUA</strong>.
                            </li>
                            <li>
