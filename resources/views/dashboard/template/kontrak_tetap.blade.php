    ...
    <div class="letter-inner">
        ...
        <div class="letter-body">
            ...
            <div class="letter-content">
                <p>
                    --Pada hari ini, {{ hariIndo(date('N')) }}, tanggal {{ date('d-m-Y') }} ({{ tanggalIndoText(date('d-m-Y')) }}), telah dibuat suatu perjanjian kerja antara pihak-pihak sebagai berikut :
                </p>
                ...
                <p class="mt-1">
                    --<strong>PIHAK PERTAMA</strong> dan <strong>PIHAK KEDUA</strong> dalam kedudukannya sebagaimana diatas terlebih dahulu menerangkan hal-hal sebagai berikut :
                </p>

                <ol>
                    <li>
                        Bahwa <strong>PIHAK KEDUA</strong> telah melaksanakan masa percobaan selama 3 (tiga) bulan berdasarkan Perjanjian Kerja Masa Percobaan Nomor: 001/PKMS/MAHA.HR.RO/IX/2023, Tanggal 25 September 2023;
                    </li>
                    <li>
                        Bahwa berdasarkan penilaian dan evaluasi <strong>PIHAK PERTAMA</strong> selama masa percobaan, <strong>PIHAK KEDUA</strong> dinyatakan lulus masa percobaan dan diangkat menjadi karyawan tetap <strong>PIHAK PERTAMA</strong>.
                    </li>
                </ol>

                <p class="mt-1">
                    --Bahwa berdasarkan hal tersebut diatas, maka <strong>PIHAK PERTAMA</strong> dan <strong>PIHAK KEDUA</strong> sepakat dan setuju untuk melakukan Perjanjian Kerja Waktu Tidak Tertentu (PKWTT) yang selanjutnya disebut sebagai perjanjian, dengan syarat-syarat dan ketentuan-ketentuan sebagai berikut :
                </p>
                ...
                <div class="pasal-wrapper">
                    ...
                    <div class="pasal-body mt-2">
                        <ol class="p-0">
                            ...
                            <li>
                                <strong>PIHAK KEDUA</strong> dengan ini bersedia memberi pelatihan kepada karyawan baru yang menggantikan dirinya dikarenakan pengunduran diri <strong>PIHAK KEDUA</strong> sebagaimana Pasal 10 Ayat (2) paling sedikit selama 30 (tiga puluh) hari kerja sebelum hari terakhir bekerja.
                            </li>
                            <li>
