...
<main id="main-dashboard">
    ...
    <section id="menu-wrapper">
        ...
        <form action="{{ route('reimbursement.store') }}" method="POST">
            @csrf
            <input type="hidden" value="56" name="id_pengajuan">
            <div class="form-group">
                <div class="row" style="overflow-x: auto;">
                    <div class="col">
                        {{$nomor}} / PPB .
                        <input type="hidden" id="depan" value="{{$nomor}}/PPB.">
            ...
            <div class="form-group">
                <input type="text" name="tanggal" class="form-control calendar" placeholder="Tanggal" autocomplete="off" required>
            </div>
            <div class="form-group">
                <input type="text" name="due_date" class="form-control calendar" placeholder="Due Date" autocomplete="off" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-danger">Ajukan PPB</button>
        </form>
