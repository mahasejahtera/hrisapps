...
class ManajerTController extends Controller
{

    public function option(Request $request)
    {
        return view('tugas.manajer.option');
    }
    ...
    public function listmasuk(Request $request)
    {
        ...
        return view('tugas.manajer.masuk', compact('data'));
    }
    ...
    public function listkeluar(Request $request)
    {
        ...
        return view('tugas.manajer.keluar', compact('data'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if($karyawan->kode_dept == 'HR'){
            $Allkaryawan = Karyawan::whereIn('role_id', [1,2,3])->get();
        }else{
            $Allkaryawan = Karyawan::where('role_id', 1)
            ->where('kode_dept', $kode_dept)
            ->get();
        }
        return view('tugas.manajer.add', compact('Allkaryawan', 'idk', 'kode_dept'));
    }
    ...
    public function addproses(Request $request)
    {
        ...
        if ($file->getClientOriginalExtension() === 'pdf') {
            ...
            Tugas::create($data);
            return redirect('/manajer/tugas/keluar')->with('success', 'Tugas Ditambah !');
        } else {
    ...
    public function detailKeluar(string $id)
    {
        ...
        return view('tugas.manajer.detail-keluar', compact('data'));
    }
